...
/**
 * Created by mijares on 24/07/2017.
 */
...
public class ReservationControllerTest {
    ...
    public void getReservations() throws Exception{
        ...
        mockRoomReservation.setGuestId( 100 );
        mockRoomReservation.setRoomName( "JUnit Room" );
        mockRoomReservationList.add( mockRoomReservation );

        given(reservationService.getRoomReservationsForDate( "2017-01-01" )).willReturn( mockRoomReservationList );
